...
> List every conclusion you currently hold about peer `alice` on workspace `workspace-a`, grouped by topic. Flag any that contradict each other or that reference specific projects/tools that may have rotated out.
