...
[![Version](https://img.shields.io/badge/version-1.0.0--oc-blue)](https://github.com/offendingcommit/claude-honcho)
...
- **Tagged as `v${version}`** — clearly distinguishable from upstream releases
